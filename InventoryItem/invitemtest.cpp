...
int main() {
    ...
    // There are 4 issues that come up when you use a pointer as a data member.
    // You must include in your class:
    ...
    // If you don't have an overloaded assignment operator,
    // the next 8 lines will give you incorrect results.  Try it!
    ...
    // if statement in the assignment operator.
    // Take the if statement out and see what happens.
    ...
    // the call to f will change the value of item1,
    // even though pass-by-value was used.
